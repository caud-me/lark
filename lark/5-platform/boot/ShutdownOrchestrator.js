...
export class ShutdownOrchestrator {
    ...
    async execute() {
        ...
        const excludedServices = ['ShutdownOrchestrator', 'BootService', 'LogService', 'ErrorService'];
        ...
        for (const [name, service] of services.entries()) {
            ...
            if (typeof service.shutdown === 'function') {
                try {
                    ...
                    console.error(`[ShutdownOrchestrator] Error calling shutdown() on ${name}:`, e);
                }
            }
            if (typeof service.dispose === 'function') {
                try {
                    ...
                    console.error(`[ShutdownOrchestrator] Error calling dispose() on ${name}:`, e);
                }
            }
        }
