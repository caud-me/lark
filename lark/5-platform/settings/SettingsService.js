...
export class SettingsService {
    ...
    onChange(callback) {
        ...
        EventBus.on('system.settings.changed', handler);
        EventBus.on('system.settings.reset', handler);
        return () => {
            EventBus.off('system.settings.changed', handler);
            EventBus.off('system.settings.reset', handler);
        };
    }
}
