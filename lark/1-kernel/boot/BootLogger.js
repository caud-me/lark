 ...
 * Layer: 1-kernel/boot
 * Responsibility:
 * Centralized kernel boot logging and stage timing telemetry. Active strictly during
 * kernel startup; deactivates upon handoff to platform runtime.
 * 
 * Does NOT:
 * - Handle post-boot runtime logging (delegated to LogService via EventBus)
 */
