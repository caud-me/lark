...
## Architecture
Like widgets, this does not have a main window. It registers as a search provider which the `SearchService` invokes when the user queries Spotlight Search.
