...
export class LocalStorageDriver {
    ...
    _loadDisk() {
        try {
            ...
            console.error('[LocalStorageDriver] Failed to load disk image', e);
    ...
    _migrateLegacyDisk() {
        ...
        if (needsMigration) {
            console.log('[LocalStorageDriver] Found legacy storage keys, migrating to virtual disk image...');
            ...
            if (this._saveDisk()) {
                ...
                console.log('[LocalStorageDriver] Migration complete and legacy keys removed.');
            }
        }
    ...
    _saveDisk() {
        try {
            ...
            console.error('[LocalStorageDriver] Write failed (Quota exceeded?)', e);
            return false;
        }
    }
